      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
           <span style="color: red"> <h4>ATENÇÃO <i class="bi bi-exclamation-circle-fill"></i></h4></span>
          ...
          <div class="modal-footer">
           ...
           <a href="http://10.100.1.215/smartshare/bd/deletarEmp2.php?id=<?php echo $ID_EMPRESA ?>"><button type="button" class="btn btn-danger">Deletar</button></a>
          </div>
        </div>
      </div>
