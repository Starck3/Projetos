  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="empresas.php?pg=<?= $_GET['pg'] ?>&tela=<?= $_GET['tela'] ?>">Empresas</a></li>
          ...
          <div class="card-body">
            ...
            <form>
              <div class="row mb-3 mt-4">
                ...
                <div class="col-lg-5">
                  <input type="text" class="form-control" maxlength="2" placeholder="INSIRA NOVA EMPRESA" require>
                </div>
              </div>
              <div class="row mb-3">
              ...
              <div class="row mb-3">
                ...
                <div class="col-lg-5">
                  <input type="text" class="form-control" placeholder="INSIRA NOVA EMPRESA APOLLO" maxlength="2" require>
                </div>
              </div>
              <div class="row mb-3">
                ...
                <div class="col-lg-5">
                  <input type="text" class="form-control" placeholder="INSIRA NOVA REVENDA APOLLO" maxlength="2" require>
                </div>
                <div class="row mt-4">
                  ...
                  <div class="col-lg-5" style="margin-top: 12px;">
                    <input type="text" class="form-control" placeholder="INSIRA NOVO ORGANOGRAMA SENIOR" maxlength="2" require>
                  </div>
                </div>
                <div class="row mt-3">
                  ...
                  <div class="col-lg-5">
                    <input type="text" class="form-control" maxlength="2"  placeholder="INSIRA NOVA EMPRESA SENIOR" require>
                  </div>
                </div>
                <div class="row mt-3">
                  ...
                  <div class="col-lg-5">
                    <input type="text" class="form-control" maxlength="2" placeholder="INSIRA NOVA FILIAL SENIOR" require>
                  </div>
                </div>
                <div class="row mt-3">
